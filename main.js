...
let projects = [
  {
    image: 'textures/Fenil2.png',
    url: 'https://hilarious-baklava-186c7c.netlify.app/',
  },
  {
    image:'textures/Fenil.png',
    url: 'https://lucent-hotteok-53a1e3.netlify.app/',
  },
  {
    image: 'textures/Fenil3.png',
    url: '#Comming Soon',
  },
  {
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('Fenil Gondaliya', {
      font: font,
      size: 0.08,
      height: 0.01,
    });  
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      'Full Stack Web Developer / Freelancer / Business Development Executive',
      {
        font: font,
        size: 0.018,
        height: 0,
